const DATA = {
  characters: {
    ...
    "paula-jara":         {name:"Paula Jara",              role:"— rol pendiente —", tier:"primario", color:"#e0b84f", photos:["images/paula-jara-1.png","images/paula-jara-2.png"], bio:"Psiquiatra de profesión. Chica de altura media, cuerpo curvilíneo y morena, que se viste muy elegantemente. Muy divertida y buena para la fiesta — le encanta ser el centro de atención, bailar, gritar y cantar frente a todos. Muy buena amiga y siempre está alegre y feliz.", apodo:null, frase:null, habilidad:null, destino:null, tags:[]},
    ...
    "fernanda-monsalve":  {name:"Fernanda Monsalve",       role:"— rol pendiente —", tier:"primario", color:"#8b6bf2", photos:["images/fernanda-monsalve-1.png","images/fernanda-monsalve-2.png"], bio:"Chica de altura media, contextura curvilínea, con pelo enrulado. Bastante alternativa y media hippie, de izquierda, vegana y animalista. Le gustan las conversaciones profundas y es media distraída. Muy amable y alegre.", apodo:null, frase:null, habilidad:null, destino:null, tags:[]},
    "maria-ignacia-cardenas": {name:"María Ignacia Cárdenas", role:"— rol pendiente —", tier:"primario", color:"#3f8c82", photos:["images/maria-ignacia-cardenas-1.png","images/maria-ignacia-cardenas-2.png","images/maria-ignacia-cardenas-3.png"], bio:"Kinesióloga de profesión, con una espalda ancha y musculosa (fue lanzadora de disco de niña). Extremadamente alegre y motivada, siempre dispuesta a todo: hacer ejercicio, trotar, cocinar, organizar actividades. Es como la \"mamá\" del grupo en el sentido de que cocina espectacular y le encanta preparar cosas ricas y elaboradas. Habla mucho, es gritona (en el buen sentido) y muy feliz.", apodo:null, frase:null, habilidad:null, destino:null, tags:[]},
    "heidi-meyer":        {name:"Heidi Meyer",             role:"— rol pendiente —", tier:"primario", color:"#c9853f", photos:["images/heidi-meyer-1.png","images/heidi-meyer-2.png","images/heidi-meyer-3.png"], bio:"Traumatóloga de profesión. Rubia, alta, de aspecto un poco alemán, deportista y muy simpática — siempre está sonriendo. Vegana, pero de estilo más estilizado que hippie. Muy buena para la fiesta y la diversión.", apodo:null, frase:null, habilidad:null, destino:null, tags:[]},
