const DATA = {
  characters: {
    ...
    "paula-jara":         {name:"Paula Jara",              role:"— rol pendiente —", tier:"primario", color:"#e0b84f", photos:["images/characters/paula-jara/2.png","images/characters/paula-jara/1.png"], bio:"Psiquiatra de profesión. Chica de altura media, cuerpo curvilíneo y morena, que se viste muy elegantemente. Muy divertida y buena para la fiesta — le encanta ser el centro de atención, bailar, gritar y cantar frente a todos. Muy buena amiga y siempre está alegre y feliz.", apodo:null, frase:null, habilidad:null, destino:null, tags:[]},
    "valeria-dassori":    {name:"Valeria Dassori",         role:"— rol pendiente —", tier:"primario", color:"#f2a65a", photos:["images/characters/valeria-dassori/1.png","images/characters/valeria-dassori/2.png"], bio:"Cuéntame el rol de Valeria en el grupo, su personalidad y alguna anécdota o dato curioso.", apodo:null, frase:null, habilidad:null, destino:null, tags:[]},
    "fernanda-monsalve":  {name:"Fernanda Monsalve",       role:"— rol pendiente —", tier:"primario", color:"#8b6bf2", photos:["images/characters/fernanda-monsalve/2.png","images/characters/fernanda-monsalve/1.png"], bio:"Chica de altura media, contextura curvilínea, con pelo enrulado. Bastante alternativa y media hippie, de izquierda, vegana y animalista. Le gustan las conversaciones profundas y es media distraída. Muy amable y alegre.", apodo:null, frase:null, habilidad:null, destino:null, tags:[]},
    ...
    "gaston":             {name:"Gastón",                  role:"— rol pendiente —", tier:"secundario", color:"#7fae6f", bio:"Cuéntame el rol de Gastón en el grupo, su personalidad y alguna anécdota o dato curioso.", apodo:null, frase:null, habilidad:null, destino:null, tags:[]},
