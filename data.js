const DATA = {
  characters: {
    ...
    "paula-jara":         {name:"Paula Jara",              role:"— rol pendiente —", tier:"primario", color:"#e0b84f", bio:"Psiquiatra de profesión. Chica de altura media, cuerpo curvilíneo y morena, que se viste muy elegantemente. Muy divertida y buena para la fiesta — le encanta ser el centro de atención, bailar, gritar y cantar frente a todos. Muy buena amiga y siempre está alegre y feliz.", apodo:null, frase:null, habilidad:null, destino:null, tags:[]},
